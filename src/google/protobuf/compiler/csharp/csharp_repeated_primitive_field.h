...
#ifndef GOOGLE_PROTOBUF_COMPILER_CSHARP_CSHARP_REPEATED_PRIMITIVE_FIELD_H__
#define GOOGLE_PROTOBUF_COMPILER_CSHARP_CSHARP_REPEATED_PRIMITIVE_FIELD_H__
...
#endif  // GOOGLE_PROTOBUF_COMPILER_CSHARP_CSHARP_REPEATED_PRIMITIVE_FIELD_H__
